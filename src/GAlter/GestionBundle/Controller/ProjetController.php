...
use GAlter\GestionBundle\Entity\Projet;
use GAlter\GestionBundle\Form\ProjetType;
...
class ProjetController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GAlterGestionBundle:Projet')->findAll();
     ...
     * @Method("POST")
     * @Template("GAlterGestionBundle:Projet:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GAlterGestionBundle:Projet')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("GAlterGestionBundle:Projet:edit.html.twig")
     */
