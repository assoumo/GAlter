 ...
 */
class Annee_Formation_Etudiant extends \GAlter\GestionBundle\Entity\Annee_Formation_Etudiant implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GAlter\\GestionBundle\\Entity\\Annee_Formation_Etudiant' . "\0" . 'id', '' . "\0" . 'GAlter\\GestionBundle\\Entity\\Annee_Formation_Etudiant' . "\0" . 'etudiants', '' . "\0" . 'GAlter\\GestionBundle\\Entity\\Annee_Formation_Etudiant' . "\0" . 'Formations', '' . "\0" . 'GAlter\\GestionBundle\\Entity\\Annee_Formation_Etudiant' . "\0" . 'anneeFormation');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Annee_Formation_Etudiant $proxy) {
