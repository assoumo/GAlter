 ...
 */
class TuteurEntreprise extends \GAlter\UserBundle\Entity\TuteurEntreprise implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nom', 'prenom', 'adresse', 'telephone', 'organisation', 'Etudiant', '' . "\0" . 'GAlter\\UserBundle\\Entity\\TuteurEntreprise' . "\0" . 'remarqueTuteurRapport', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TuteurEntreprise $proxy) {
    ...
    public function addRemarqueTuteurRapport(\GAlter\GestionBundle\Entity\RemarqueTuteurRapport $remarqueTuteurRapport)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addRemarqueTuteurRapport', array($remarqueTuteurRapport));

        return parent::addRemarqueTuteurRapport($remarqueTuteurRapport);
    }
    ...
    public function removeRemarqueTuteurRapport(\GAlter\GestionBundle\Entity\RemarqueTuteurRapport $remarqueTuteurRapport)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeRemarqueTuteurRapport', array($remarqueTuteurRapport));

        return parent::removeRemarqueTuteurRapport($remarqueTuteurRapport);
    }
    ...
    public function getRemarqueTuteurRapport()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRemarqueTuteurRapport', array());

        return parent::getRemarqueTuteurRapport();
    }
