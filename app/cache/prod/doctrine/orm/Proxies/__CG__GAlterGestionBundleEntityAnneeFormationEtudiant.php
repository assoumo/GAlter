 ...
 */
class AnneeFormationEtudiant extends \GAlter\GestionBundle\Entity\AnneeFormationEtudiant implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AnneeFormationEtudiant $proxy) {
