...
class Responsable extends \GAlter\UserBundle\Entity\Responsable implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nom', 'prenom', 'adresse', 'telephone', 'RespContrat', '' . "\0" . 'GAlter\\UserBundle\\Entity\\Responsable' . "\0" . 'formation', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function setRespContrat($respContrat)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRespContrat', array($respContrat));

        return parent::setRespContrat($respContrat);
    }
    ...
    public function getRespContrat()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRespContrat', array());

        return parent::getRespContrat();
    }
