 ...
 */
class Responsable extends \GAlter\UserBundle\Entity\Responsable implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nom', 'prenom', 'adresse', 'telephone', 'organisation', 'Etudiant', '' . "\0" . 'GAlter\\UserBundle\\Entity\\Responsable' . "\0" . 'remarqueResponsableRapport', '' . "\0" . 'GAlter\\UserBundle\\Entity\\Responsable' . "\0" . 'formations', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function addRemarqueResponsableRapport(\GAlter\GestionBundle\Entity\RemarqueResponsableRapport $remarqueResponsableRapport)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addRemarqueResponsableRapport', array($remarqueResponsableRapport));

        return parent::addRemarqueResponsableRapport($remarqueResponsableRapport);
    }
    ...
    public function removeRemarqueResponsableRapport(\GAlter\GestionBundle\Entity\RemarqueResponsableRapport $remarqueResponsableRapport)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeRemarqueResponsableRapport', array($remarqueResponsableRapport));

        return parent::removeRemarqueResponsableRapport($remarqueResponsableRapport);
    }
    ...
    public function getRemarqueResponsableRapport()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRemarqueResponsableRapport', array());

        return parent::getRemarqueResponsableRapport();
    }
