 ...
 */
class RemarqueTuteurRapport extends \GAlter\GestionBundle\Entity\RemarqueTuteurRapport implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RemarqueTuteurRapport $proxy) {
    ...
    public function setTuteurId(\GAlter\UserBundle\Entity\Tuteur $tuteurId = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTuteurId', array($tuteurId));

        return parent::setTuteurId($tuteurId);
    }
    ...
    public function getTuteurId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTuteurId', array());

        return parent::getTuteurId();
    }
    ...
    public function setTuteurIdRapport(\GAlter\GestionBundle\Entity\Rapport $tuteurIdRapport = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTuteurIdRapport', array($tuteurIdRapport));

        return parent::setTuteurIdRapport($tuteurIdRapport);
    }
