...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'galter', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\GAlter\\UserBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\GAlter\\GestionBundle\\Entity')));
        ...
        $d->addDriver($b, 'GAlter\\UserBundle\\Entity');
        $d->addDriver($b, 'GAlter\\GestionBundle\\Entity');
        ...
        $e->setEntityNamespaces(array('GAlterUserBundle' => 'GAlter\\UserBundle\\Entity', 'GAlterGestionBundle' => 'GAlter\\GestionBundle\\Entity', 'FOSMessageBundle' => 'FOS\\MessageBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_5865d0affe90de330f8ab2aa19cfb0cd201df3dd091650d90562f2ae7ef3b27e');
        return $instance;
    }
    ...
    {
        return $this->services['fos_message.message_manager'] = new \FOS\MessageBundle\EntityManager\MessageManager($this->get('doctrine.orm.default_entity_manager'), 'GAlter\\UserBundle\\Entity\\Message', 'GAlter\\UserBundle\\Entity\\MessageMetadata');
    }
    ...
    {
        return $this->services['fos_message.thread_manager'] = new \FOS\MessageBundle\EntityManager\ThreadManager($this->get('doctrine.orm.default_entity_manager'), 'GAlter\\UserBundle\\Entity\\Thread', 'GAlter\\UserBundle\\Entity\\ThreadMetadata', $this->get('fos_message.message_manager'));
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('GAlter\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.group.form.type'] = new \FOS\UserBundle\Form\Type\GroupFormType('GAlter\\UserBundle\\Entity\\Groupe');
    }
    protected function getFosUser_GroupManagerService()
    {
        return $this->services['fos_user.group_manager'] = new \FOS\UserBundle\Doctrine\GroupManager($this->get('fos_user.entity_manager'), 'GAlter\\UserBundle\\Entity\\Groupe');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting.template' => 'FOSUserBundle:Resetting:email.txt.twig', 'from_email' => array('confirmation' => array('noreply@xxxxx.com' => 'GALTER\' TEAM'), 'resetting' => array('webmaster@example.com' => 'webmaster'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('GAlter\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('GAlter\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('GAlter\\UserBundle\\Entity\\User');
    }
    ...
    protected function getPugxUser_Manager_OrmUserManagerService()
    {
        ...
        return $this->services['pugx_user.manager.orm_user_manager'] = new \PUGX\MultiUserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('fos_user.entity_manager'), 'GAlter\\UserBundle\\Entity\\User', $this->get('pugx_user.manager.user_discriminator'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $n = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $l, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($l, '/login'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'fos_user_security_logout'));
        ...
        $o->setOptions(array('login_path' => 'fos_user_security_login', 'always_use_default_target_path' => true, 'default_target_path' => '/profile', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $p->setOptions(array('login_path' => 'fos_user_security_login', 'failure_path' => '/login', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\GAlter\\UserBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\GAlter\\UserBundle/Resources/views'), 'GAlterUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\GAlter\\GestionBundle/Resources/views'), 'GAlterGestion');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->setConstraintValidatorFactory(new \Symfony\Bundle\FrameworkBundle\Validator\ConstraintValidatorFactory($this, array('validator.expression' => 'validator.expression', 'Symfony\\Component\\Validator\\Constraints\\EmailValidator' => 'validator.email', 'security.validator.user_password' => 'security.validator.user_password', 'doctrine.orm.validator.unique' => 'doctrine.orm.validator.unique', 'pugx.orm.validator.unique' => 'pugx_multi_user.orm.validator.unique', 'fos_message.validator.authorization' => 'fos_message.validator.authorization', 'fos_message.validator.reply_authorization' => 'fos_message.validator.reply_authorization', 'fos_message.validator.spam' => 'fos_message.validator.spam', 'fos_message.validator.self_recipient' => 'fos_message.validator.self_recipient')));
    ...
    {
        return $this->services['fos_user.user_to_username_transformer'] = new \FOS\UserBundle\Form\DataTransformer\UserToUsernameTransformer($this->get('pugx_user.manager.orm_user_manager'));
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ETUDIANT' => array(0 => 'ROLE_ETUDIANT'), 'ROLE_ADMIN' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN', 2 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'GAlterUserBundle' => 'GAlter\\UserBundle\\GAlterUserBundle',
                'GAlterGestionBundle' => 'GAlter\\GestionBundle\\GAlterGestionBundle',
            ...
            'pugx_user_discriminator_users' => array(
                'user_one' => array(
                    'entity' => array(
                        'class' => 'GAlter\\UserBundle\\Entity\\Etudiant',
                        'factory' => 'PUGX\\MultiUserBundle\\Model\\UserFactory',
                    ),
                    'registration' => array(
                        'form' => array(
                            'type' => 'GAlter\\UserBundle\\Form\\Type\\RegistrationUserOneFormType',
                        ...
                        'template' => 'GAlterUserBundle:Registration:user_one.form.html.twig',
                    ),
                    'profile' => array(
                        'form' => array(
                            'type' => 'GAlter\\UserBundle\\Form\\Type\\ProfileUserOneFormType',
                ...
                'user_two' => array(
                    'entity' => array(
                        'class' => 'GAlter\\UserBundle\\Entity\\Tuteur',
                        'factory' => 'PUGX\\MultiUserBundle\\Model\\UserFactory',
                    ),
                    'registration' => array(
                        'form' => array(
                            'type' => 'GAlter\\UserBundle\\Form\\Type\\RegistrationUserTwoFormType',
                            'name' => 'fos_user_registration_form',
                            'validation_groups' => array(
                                0 => 'Registration',
                                1 => 'Default',
                        ...
                        'template' => 'GAlterUserBundle:Registration:user_two.form.html.twig',
                    ),
                    'profile' => array(
                        'form' => array(
                            'type' => 'GAlter\\UserBundle\\Form\\Type\\ProfileUserTwoFormType',
                            'name' => 'fos_user_profile_form',
                            'validation_groups' => array(
                                0 => 'Profile',
                                1 => 'Default',
                ...
                'user_three' => array(
                    ...
                    'registration' => array(
                        'form' => array(
                            'type' => 'GAlter\\UserBundle\\Form\\Type\\RegistrationUserThreeFormType',
                            'name' => 'fos_user_registration_form',
                            'validation_groups' => array(
                                0 => 'Registration',
                                1 => 'Default',
                        ...
                        'template' => 'GAlterUserBundle:Registration:user_three.form.html.twig',
                    ),
                    'profile' => array(
                        'form' => array(
            ...
            'fos_user.model.user.class' => 'GAlter\\UserBundle\\Entity\\User',
            ...
            'fos_user.model.group.class' => 'GAlter\\UserBundle\\Entity\\Groupe',
            ...
            'fos_message.message_meta_class' => 'GAlter\\UserBundle\\Entity\\MessageMetadata',
            'fos_message.thread_meta_class' => 'GAlter\\UserBundle\\Entity\\ThreadMetadata',
            'fos_message.message_class' => 'GAlter\\UserBundle\\Entity\\Message',
            'fos_message.thread_class' => 'GAlter\\UserBundle\\Entity\\Thread',
