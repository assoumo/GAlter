...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $m->setOptions(array('login_path' => 'fos_user_security_login', 'failure_path' => '/Accueil', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));
